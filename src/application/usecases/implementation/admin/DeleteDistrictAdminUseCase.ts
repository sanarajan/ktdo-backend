...
import { IDeleteDistrictAdminUseCase } from '../../interface/admin/IDeleteDistrictAdminUseCase';

@injectable()
export class DeleteDistrictAdminUseCase implements IDeleteDistrictAdminUseCase {
    constructor(
